        ...
        <div class="col-md-12">
            <div class="card shadow-lg border-0 rounded-4">
                <div class="card-header bg-gradient-primary text-white rounded-top-4 d-flex justify-content-between align-items-center" style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%);">
                    <h5 class="mb-0">
                        <i class="fas fa-users me-2"></i> Student Enrollments
                    </h5>
                    <a href="{{ route('enrollments.create') }}" class="btn btn-light btn-sm">
                        ...
                        <table class="table table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <span class="badge bg-info">{{ $enrollment->course->course_code ?? 'N/A' }}</span>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <div class="btn-group" role="group">
                                            <a href="{{ route('enrollments.show', $enrollment->enrollment_id) }}" class="btn btn-sm btn-info" title="View">
                                                <i class="fas fa-eye"></i>
                                            </a>
                                            <a href="{{ route('enrollments.edit', $enrollment->enrollment_id) }}" class="btn btn-sm btn-warning" title="Edit">
                                            ...
                                            <form id="delete-form-{{ $enrollment->enrollment_id }}"
                                ...
                                <tr>
                                    <td colspan="6" class="text-center text-muted py-4">
                                        ...
                                        <br>
                                        <a href="{{ route('enrollments.create') }}" class="btn btn-sm btn-primary mt-2">
